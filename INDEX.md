...
- re/patterns/igb-model-scene-format.md — Header, meta-field table, class table, and object directory (Alchemy IGB), Text… (3 techniques logged)
...
- re/patterns/xbox360-recompiler-gpu-debugging.md — Localizing an Xenos "invalid fetch constant" black-screen to a bad guest predic… (2 techniques logged)
...
- re/solved-problems/xbox-recomp-wall21-missing-found-check-recurs-on-nonempty-table.md — The same missing found/not-found check on a binary search, already fixed once for an empty-table case, reappeared as a raw host-memory crash (not a wrapped guest-address crash) once the table held real entries and the search legitimately missed
...
- re/tool-notes/rexglue-sdk.md (23 notes)
